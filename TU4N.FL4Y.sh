...
echo $i" |"$cy"     PERKUMPULAN CYBER INDONESIAN"$i"            |"
echo $i" |"$me"─────────────────────────────────────────────"$i"|"
echo $i" |"$pu" AUTHOR :"$ku" TU4N.FL4Y"$i"                          |"
echo $i" |"$pu" FACEBOOK :"$ku" KEPO.CUK"$i"                         |"
echo $i" |"$pu" THANKS TO :"$cy" TUHAN YANG MAHA ESA" $i"            |"
echo $i" |"$pu" Contack WhatsApp :"$ku"08560xxxx"$i"                 |"
echo $i" |"$pu" Contack Gmail :"$ku" cyber.lokal@fl4y.com"$i"        |"
echo $i"["$bi"•"$i"]"$me"───────────────────────────────────────────"$i"["$bi"•"$i"]"
echo
echo $i"────────────────────────────────    ─────"
...
echo $i"────────────────────────────────    ─────"
echo
echo $me"┌==="$bi"["$i"TU4N.FL4Y"$bi"]"$me"======"$bi"["$i""Pilih Nomornya""$bi"]"
echo $me"¦"
read -p"└──# " pil
...
sleep 2
echo $ku"WhatsApp :"$i" 08560xxxxxx"
echo $ku"Facebook :"$i" TU4N.FL4Y"
sleep 2
echo $pur">> JANGAN LUPA BAHAGIA <<"
exit
fi
